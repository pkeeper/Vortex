...
def DrawBox(position,dimensions,rotation,color):
        """Draw simple box"""
        ...
        glPushMatrix()                    # We are done with the polygon
        ...
        glColor3f(color[0],color[1],color[2])            # Set The Color To Blue
...
class GraphicsEngine():
    ...
    #    glRotatef(0, 1, 0, 0)
        ...
        for Object in self.active:
            DrawBox(Object.position,Object.dimensions,Object.rotation,Object.color)
